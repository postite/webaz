...
var app_Client = function() {
	console.log("src/app/Client.hx:13:","hello" + Std.string(new Date()));
	this.r = new tink_web_proxy_Remote0(new tink_http_clients_JsClient(),tink_web_proxy__$Remote_RemoteEndpoint_$Impl_$._new(tink_url__$Host_Host_$Impl_$._new("zecastpod.local")));
	this.execute();
};
$hxClasses["app.Client"] = app_Client;
app_Client.__name__ = true;
...
app_Client.prototype = {
	execute: function() {
		...
		while(a.hasNext()) {
			var a1 = a.next();
			Type.createInstance(wire__$ActionCommand_ActionCommand_$Impl_$.toClass(a1),[]).execute(__map_reserved[a1] != null ? t.getReserved(a1) : t.h[a1]);
		}
	}
};
var app_IRemoteRoot = function() { };
$hxClasses["app.IRemoteRoot"] = app_IRemoteRoot;
app_IRemoteRoot.__name__ = true;
var wire_ICommand = function() { };
$hxClasses["wire.ICommand"] = wire_ICommand;
wire_ICommand.__name__ = true;
...
command_MyCommand2.prototype = {
	execute: function(data) {
		console.log("src/command/MyCommand2.hx:6:","execute command2" + Std.string(data));
	}
};
...
wire__$ActionCommand_ActionCommand_$Impl_$.__name__ = true;
