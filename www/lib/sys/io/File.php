 ...
 * Haxe source file: /Users/ut/haxe/versions/4.0.0-rc.2/std/php/_std/sys/io/File.hx
 */
...
class File {
	...
	static public function append ($path, $binary = true) {
		#/Users/ut/haxe/versions/4.0.0-rc.2/std/php/_std/sys/io/File.hx:56: characters 3-66
		if ($binary === null) {
			$binary = true;
		}
	...
	static public function copy ($srcPath, $dstPath) {
		#/Users/ut/haxe/versions/4.0.0-rc.2/std/php/_std/sys/io/File.hx:67: characters 3-32
	...
	static public function getBytes ($path) {
		#/Users/ut/haxe/versions/4.0.0-rc.2/std/php/_std/sys/io/File.hx:34: characters 10-57
	...
	static public function getContent ($path) {
		#/Users/ut/haxe/versions/4.0.0-rc.2/std/php/_std/sys/io/File.hx:30: characters 3-33
	...
	static public function read ($path, $binary = true) {
		#/Users/ut/haxe/versions/4.0.0-rc.2/std/php/_std/sys/io/File.hx:48: characters 3-73
		if ($binary === null) {
			$binary = true;
		}
	...
	static public function saveBytes ($path, $bytes) {
		#/Users/ut/haxe/versions/4.0.0-rc.2/std/php/_std/sys/io/File.hx:42: characters 3-23
		$f = File::write($path);
		#/Users/ut/haxe/versions/4.0.0-rc.2/std/php/_std/sys/io/File.hx:43: characters 3-17
		$f->write($bytes);
		#/Users/ut/haxe/versions/4.0.0-rc.2/std/php/_std/sys/io/File.hx:44: characters 3-12
		$f->close();
	}
	...
	static public function saveContent ($path, $content) {
		#/Users/ut/haxe/versions/4.0.0-rc.2/std/php/_std/sys/io/File.hx:38: characters 3-35
	...
	static public function write ($path, $binary = true) {
		#/Users/ut/haxe/versions/4.0.0-rc.2/std/php/_std/sys/io/File.hx:52: characters 3-66
		if ($binary === null) {
			$binary = true;
		}
