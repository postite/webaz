 ...
 * Haxe source file: /Users/ut/haxe/haxe_libraries/tink_streams/0.3.2/haxelib/src/tink/streams/RealStream.hx
 */
...
final class RealStream_Impl_ {
	...
	static public function collect ($this1) {
		...
		$ret = $this1->forEach(Handler_Impl_::ofSafe(function ($x)  use (&$buf) {
			...
			if ($__hx__switch === 0) {
				...
				#/Users/ut/haxe/haxe_libraries/tink_streams/0.3.2/haxelib/src/tink/streams/RealStream.hx:32: characters 15-16
				$e = $c->params[0];
