		...
		return Future_Impl_::async(function ($cb)  use (&$_gthis, &$handler) {
			...
			$_gthis->upcoming->handle(function ($e)  use (&$_gthis, &$handler, &$cb) {
				...
				if ($__hx__switch === 0) {
					...
					$then = $e->params[1];
					#/Users/ut/haxe/haxe_libraries/tink_streams/0.3.2/haxelib/src/tink/streams/Stream.hx:688: characters 19-20
					$v = $e->params[0];
					...
					$handler($v)->handle(function ($s)  use (&$then, &$_gthis, &$handler, &$cb) {
						...
						if ($__hx__switch === 0) {
							...
							#/Users/ut/haxe/haxe_libraries/tink_streams/0.3.2/haxelib/src/tink/streams/Stream.hx:696: characters 23-24
							$e1 = $s->params[0];
					...
					#/Users/ut/haxe/haxe_libraries/tink_streams/0.3.2/haxelib/src/tink/streams/Stream.hx:699: characters 19-20
					$e2 = $e->params[0];
