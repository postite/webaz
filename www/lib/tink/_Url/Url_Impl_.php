 ...
 * Haxe source file: /Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/Url.hx
 */
...
final class Url_Impl_ {
	...
	static public function _new ($parts) {
		#/Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/Url.hx:22: character 3
		return $parts;
	}
	...
	static public function makePayload ($parts) {
		...
		if ($parts->auth === null) {
			...
			if ($parts->host !== null) {
				#/Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/Url.hx:57: characters 32-36
				$host = $parts->host;
			...
			$auth1 = $parts->auth;
			#/Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/Url.hx:61: characters 32-36
			$host1 = $parts->host;
			#/Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/Url.hx:62: characters 9-34
			$payload = "" . (("//" . ((($auth1 === null ? "" : "" . ($auth1??'null') . "@"))??'null') . ($host1??'null'))??'null');
		}
	...
	static public function parse ($s, $onError = null) {
		...
		#/Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/Url.hx:143: characters 13-17
