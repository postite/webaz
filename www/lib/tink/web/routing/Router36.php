...
class Router36 {
	...
	public function create ($ctx) {
		#src/app/TinkLiteRoute.hx:18: lines 18-22
			...
			switch ($_g2) {
				case "create":
					...
					if ($_g1 === true) {
						#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/c4323c7b0c2f0b44e696eea51c9bfdff41716880/src/tink/web/macros/Routing.hx:143: characters 22-31
						if ($_g === false) {
							#src/app/TinkLiteRoute.hx:17: characters 2-6
							...
							return Promise_Impl_::ofOutcome(Outcome::Failure(new TypedError(404, "Not Found: [" . ($ctx->request->header->method??'null') . "] " . ((($this1->query === null ? $this1->path : ($this1->path??'null') . "?" . ($this1->query??'null')))??'null'), new HxAnon([
								"fileName" => "Server.hx",
								"lineNumber" => 57,
								"className" => "tink.web.routing.Router36",
								"methodName" => "route",
							]))));
						}
					} else {
				...
				case "tst":
					...
					if ($_g1 === true) {
						#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/c4323c7b0c2f0b44e696eea51c9bfdff41716880/src/tink/web/macros/Routing.hx:143: characters 22-31
						if ($_g === false) {
							#src/app/TinkLiteRoute.hx:10: characters 2-6
	...
	public function tst ($ctx) {
		#src/app/TinkLiteRoute.hx:11: lines 11-16
...
Boot::registerClass(Router36::class, 'tink.web.routing.Router36');
