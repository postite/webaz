...
use \tink\json\Writer94;
use \php\Boot;
use \tink\core\TypedError;
use \tink\core\_Future\FutureObject;
use \tink\json\Writer93;
...
class Router249 {
	...
	public function all ($ctx) {
		...
		return Promise_Impl_::next($this->target->all(), function ($__data__)  use (&$ctx) {
			...
			if (($ctx->accepts)("application/json")) {
				#src/app/TinkLiteRoute.hx:25: lines 25-28
				return Promise_Impl_::ofOutcome(Outcome::Success(Response_Impl_::textual(null, "application/json", (new Writer93())->write($__data__))));
			}
			#src/app/TinkLiteRoute.hx:25: lines 25-28
			return Promise_Impl_::ofOutcome(Outcome::Failure(new TypedError(415, "Unsupported Media Type", new HxAnon([
				...
				"lineNumber" => 25,
				"className" => "tink.web.routing.Router249",
				"methodName" => "all",
			]))));
		});
	}
	...
	public function get ($ctx, $id = null) {
		...
		#src/app/TinkLiteRoute.hx:17: lines 17-23
		return Promise_Impl_::next($p->get($p1), Next_Impl_::ofSafeSync(function ($v1) {
			#src/app/TinkLiteRoute.hx:17: lines 17-23
			return $v1;
		}));
	}
	...
	public function rec ($ctx) {
		...
		return Promise_Impl_::next($this->target->rec(), function ($__data__)  use (&$ctx) {
			...
			if (($ctx->accepts)("application/json")) {
				#src/app/TinkLiteRoute.hx:31: lines 31-35
				return Promise_Impl_::ofOutcome(Outcome::Success(Response_Impl_::textual(null, "application/json", (new Writer94())->write($__data__))));
			}
			#src/app/TinkLiteRoute.hx:31: lines 31-35
			return Promise_Impl_::ofOutcome(Outcome::Failure(new TypedError(415, "Unsupported Media Type", new HxAnon([
				"fileName" => "TinkLiteRoute.hx",
...
Boot::registerClass(Router249::class, 'tink.web.routing.Router249');
