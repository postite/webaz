 ...
 * Haxe source file: /Users/ut/haxe/haxe_libraries/tink_io/0.6.2/haxelib/src/tink/io/std/OutputSink.hx
 */
						...
						Worker_Impl_::work($_gthis->worker, new LazyFunc(function ()  use (&$pos, &$bytes, &$e1, &$e2, &$e3, &$_gthis) {
							...
							if ($__hx__switch === 0) {
								...
								if ($o->params[0] === -1) {
									...
									#/Users/ut/haxe/haxe_libraries/tink_io/0.6.2/haxelib/src/tink/io/std/OutputSink.hx:52: characters 24-25
									$v = $o->params[0];
								...
								#/Users/ut/haxe/haxe_libraries/tink_io/0.6.2/haxelib/src/tink/io/std/OutputSink.hx:56: characters 24-25
								$e4 = $o->params[0];
