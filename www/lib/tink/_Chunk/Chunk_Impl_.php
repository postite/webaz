 ...
 * Haxe source file: /Users/ut/haxe/haxe_libraries/tink_chunk/0.2.0/haxelib/src/tink/Chunk.hx
 */
...
final class Chunk_Impl_ {
	...
	static public function join ($chunks) {
		...
		if ($chunks === null) {
			...
			if ($__hx__switch === 0) {
				...
				#/Users/ut/haxe/haxe_libraries/tink_chunk/0.2.0/haxelib/src/tink/Chunk.hx:108: characters 13-14
				$v = ($chunks->arr[0] ?? null);
				...
				while ($_g < $_g1) {
					...
					$ret = Chunk_Impl_::catChunk($ret, ($chunks->arr[$i] ?? null));
				}
	...
	static public function lcatString ($a, $b) {
		#/Users/ut/haxe/haxe_libraries/tink_chunk/0.2.0/haxelib/src/tink/Chunk.hx:136: characters 21-22
		$b1 = strlen($a);
	...
	static public function ofString ($s) {
		#/Users/ut/haxe/haxe_libraries/tink_chunk/0.2.0/haxelib/src/tink/Chunk.hx:120: characters 20-37
		$b = strlen($s);
		#/Users/ut/haxe/haxe_libraries/tink_chunk/0.2.0/haxelib/src/tink/Chunk.hx:120: characters 12-38
	...
	static public function rcatString ($a, $b) {
		#/Users/ut/haxe/haxe_libraries/tink_chunk/0.2.0/haxelib/src/tink/Chunk.hx:133: characters 24-25
		$b1 = strlen($b);
	...
	static public function toHex ($this1) {
		#/Users/ut/haxe/haxe_libraries/tink_chunk/0.2.0/haxelib/src/tink/Chunk.hx:97: characters 12-34
