 ...
 * Haxe source file: /Users/ut/haxe/haxe_libraries/tink_chunk/0.2.0/haxelib/src/tink/chunk/ChunkCursor.hx
 */
...
class ChunkCursor {
	...
	public function seek ($seekable, $options = null) {
		...
		if ($_g2->index === 1) {
			...
			$_g3 = $this->curPartIndex + 1;
			$_g11 = $this->parts->length;
			while ($_g3 < $_g11) {
				$i1 = $_g3++;
				#/Users/ut/haxe/haxe_libraries/tink_chunk/0.2.0/haxelib/src/tink/chunk/ChunkCursor.hx:200: characters 18-35
				$_g4 = $part(($this->parts->arr[$i1] ?? null), 0);
				$__hx__switch = ($_g4->index);
				if ($__hx__switch === 0) {
					#/Users/ut/haxe/haxe_libraries/tink_chunk/0.2.0/haxelib/src/tink/chunk/ChunkCursor.hx:201: characters 23-24
					$v = $_g4->params[0];
