...
class ParserBase {
	...
	public function attempt ($field, $o) {
		...
		if ($__hx__switch === 0) {
			#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/Parser.hx:68: characters 20-21
			$v = $o->params[0];
			#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/Parser.hx:68: characters 24-25
			return $v;
		} else if ($__hx__switch === 1) {
			#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/Parser.hx:69: characters 20-21
			$e = $o->params[0];
		...
		if ($input !== null) {
			...
			while ($input->hasNext()) {
				...
				while ($end > 0) {
					...
					#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/Parser.hx:46: lines 46-47
					if ($_g1 > $_g) {
						#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/Parser.hx:46: characters 37-44
						$end = $_g1;
					} else {
						#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/Parser.hx:47: characters 26-33
						$end = $_g;
					}
