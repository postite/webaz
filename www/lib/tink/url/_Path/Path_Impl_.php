 ...
 * Haxe source file: /Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/url/Path.hx
 */
...
final class Path_Impl_ {
	...
	static public function _new ($s) {
		#/Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/url/Path.hx:19: character 3
		return $s;
	}
		...
		if ($that === "") {
			...
			if ((($index < 0 ? "" : mb_substr($this1, $index, 1))) === "/") {
				...
				if ($_g === -1) {
					...
					return Path_Impl_::ofString((mb_substr($this1, 0, $_g + 1)??'null') . ($that??'null'));
				}
			}
		}
	}
