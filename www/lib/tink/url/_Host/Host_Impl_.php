 ...
 * Haxe source file: /Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/url/Host.hx
 */
...
final class Host_Impl_ {
	...
	static public function _new ($name, $port = null) {
		#/Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/url/Host.hx:11: character 3
		$this1 = null;
	...
	static public function get_name ($this1) {
		...
		if ($this1 === null) {
			...
			if ($__hx__switch === 1) {
				#/Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/url/Host.hx:21: characters 17-18
				$v = ($_g->arr[0] ?? null);
				...
				#/Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/url/Host.hx:22: characters 17-18
				$v1 = ($_g->arr[0] ?? null);
	...
	static public function get_port ($this1) {
		...
		if ($this1 === null) {
			...
			$__hx__switch = ($_g->length);
			if ($__hx__switch === 1) {
				#/Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/url/Host.hx:31: characters 17-18
				$v = ($_g->arr[0] ?? null);
				...
				#/Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/url/Host.hx:31: characters 26-27
				$v1 = ($_g->arr[1] ?? null);
				#/Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/url/Host.hx:32: characters 22-37
				$_g2 = (HxString::split($v1, ":")->arr[1] ?? null);
				#/Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/url/Host.hx:33: lines 33-34
				if ($_g2 === null) {
					#/Users/ut/haxe/haxe_libraries/tink_url/0.4.1/haxelib/src/tink/url/Host.hx:33: characters 30-34
					return null;
