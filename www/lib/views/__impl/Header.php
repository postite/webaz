 ...
 * Haxe source file: src//views/Header.tt
 */
...
class Header {
	...
	static public function render () {
		...
		$ret->arr[$ret->length] = "<!-- POSITION: {\"min\":24,\"max\":28,\"file\":\"src//views/Header.tt\"} -->";
		++$ret->length;

		$ret->arr[$ret->length] = "\x0A<div class=\"ui sticky\">\x0A      <h1>Head</h1>\x0A    </div>\x0A";
		++$ret->length;
